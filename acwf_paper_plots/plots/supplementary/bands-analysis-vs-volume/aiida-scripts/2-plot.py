...
PDFOUT = f'out/{system}/pdfout'
os.makedirs(PDFOUT, exist_ok=False)
...
for filename in os.listdir(FOLDER):
    ...
    pl.savefig(os.path.join(PDFOUT, f'{basename}.pdf'))

print(f"PDF files written in '{PDFOUT}'.")
subprocess.check_output(['pdftk'] + sorted(glob.glob(f'{PDFOUT}/*.pdf')) + ['cat', 'output', f'{system}.pdf'])
print(f"Final {system}.pdf written.")
