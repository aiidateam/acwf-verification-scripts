...
if __name__ == "__main__":
    ...
    if GENERATE_XSF_FILES:
        if os.path.exists('xsfs-unaries-set1'):
            print("Remove the 'xsfs-unaries-set1' folder first.")
            sys.exit(1)
        os.makedirs('xsfs-unaries-set1')
        for Z in range(1, Z_MAX+1):
            ...
            for crystal_structure_label, unary in unaries.items():
                ...
                # problematic for BCC!
                unary.write(f'xsfs-unaries-set1/{element}-{crystal_structure_label}.xsf')
        print(f"{Z_MAX} structures written to the xsfs-unaries-set1 folder.")
