...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"No data found for your plugin '{PLUGIN_NAME}'. Did you run `./get_results_monoelemental.py` first?")
        sys.exit(1)
    ...
    if compare_with is None:
        PLOT_FOLDER = f'plots-monoelemental-{PLUGIN_NAME}'
    else:
        PLOT_FOLDER = f'plots-monoelemental-{PLUGIN_NAME}-vs-{compare_with}'
